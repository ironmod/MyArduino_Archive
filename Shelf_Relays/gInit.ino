...
//Set Buttons
  ...
  gAddSpacer(1);
  gAddToggle("Left Shelf White (D2) ", &button2);
 gAddToggle("Right Shelf White (D7)", &button7); 
  gAddToggle("Left Shelf Blue (D12)", &button12); 
  gAddToggle("Right Shelf Blue (D4)", &button4);
